...
API issues, but outside of that, only scheduling issues with my current job.
...
Have been running low on time, so I'll have to use my 48-hour extension. Wish me luck!
